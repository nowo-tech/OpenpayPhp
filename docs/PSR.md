...
Package: `nowo-tech/openpay-php` (`library`)
...
| PSR-18 HTTP client | **N/A** | Outbound HTTP uses a package-specific transport/client interface (swap in tests); PSR-18 is optional and not required for value today. |
